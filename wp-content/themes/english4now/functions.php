...
function twentythirteen_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Footer', 'english4you' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Appears in the footer section of the site.', 'twentythirteen' ),
		'before_widget' => '<section class="footer-first col-lg-3 col-md-3">',
	...
	register_sidebar( array(
		'name'          => __( 'Slider Blog', 'english4you' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<div class="wrapper-search">',
		'after_widget'  => '</div><hr />',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
...
function wp_corenavi() {
  ...
  if ($max > 1) echo '<ul class="pagination pagination-lg">';

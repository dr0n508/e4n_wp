...
//отправляем на почту
    ...
    if(!$_POST['subject']) { $_POST['subject'] =  "Новое сообщение с сайта"; }
    ...
    mail('info@english4now.com', $_POST['subject'], "Имя: ".  strip_tags($_POST['fio']). "<br>\n Тема: ".strip_tags($_POST['theme']). "<br>\n E-mail: ".strip_tags($_POST['mail']). "<br>\n Текст: ".strip_tags($_POST['text']), $headers);

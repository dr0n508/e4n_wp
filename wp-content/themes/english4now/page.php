    ...
    <div class="container">
        <div class="row">
            <section class="col-lg-8 col-md-8 col-sm-7 h1-slogan">
                ...
                <p class="about-free-lesson"><span>Первый урок - бесплатный.</span> Преподаватель учтет ваш уровень знаний, ваши цели, пожелания и проведет 45 минут полноценной языковой практики.</p>
